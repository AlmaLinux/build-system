...
The general purpose of the AlmaLinux Build System is to minimize the manual work in order to reduce the amount of human-caused mistakes.
...
* [**Build Node**](https://github.com/AlmaLinux/albs-node) sends requests to the Master Service and receives Build Tasks to build packages. After being built these packages are kept as artifacts at the **Artifact Storage**. 
